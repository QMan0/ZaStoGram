...
Это **не** новый мессенджер. Это тот же самый официальный Telegram (исходники DrKLO), но с переписанным сетевым слоем, который делает трафик к прокси неотличимым от похода обычного браузера на сайт. То что не может сделать Дуров (_снова_), но смогли сделать мы и команда TeleMT.
